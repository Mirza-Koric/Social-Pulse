...
{
    public class ConversationsService : BaseService<Conversation, ConversationDto, ConversationUpsertDto, BaseSearchObject, IConversationsRepository>, IConversationsService
    {
